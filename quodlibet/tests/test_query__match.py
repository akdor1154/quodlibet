...
class TNumericOp(TestCase):
    ...
    def test_time_format(self):
        ...
        self.assertTrue(o(5 * 60 + 12, v))

        o, v = map_numeric_op("length", "=", "10:5:10")
        self.assertTrue(o((3600 * 10) + (5 * 60) + 10, v))

    def test_date(self):
        o, v = map_numeric_op("date", ">", "2004")
        self.assertTrue(o(date_key("2004-01-02"), v))

        o, v = map_numeric_op("date", "=", "2005")
        self.assertTrue(o(date_key("2005"), v))
    ...
    def test_float(self):
        for variant in ["0.5", ".5", "+.5", "+.5e0"]:
            ...
            self.assertTrue(o(0.6, v))
            self.assertFalse(o(0.5, v))

    def test_size(self):
        o, v = map_numeric_op("filesize", ">", "10MB")
        self.assertTrue(o(1024 * 1024 * 11, v))
        self.assertFalse(o(1024 * 1024 * 9, v))

        o, v = map_numeric_op("filesize", ">", "1MB")
        self.assertTrue(o(1024 * 1024 * 1.1, v))
        self.assertFalse(o(1024 * 1024 * 0.9, v))
    ...
    def test_simple(self):
        ...
        self.assertTrue(o(5, v))
        self.assertFalse(o(5.01, v))
